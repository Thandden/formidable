...
from formidable.validators import (
    EmailValidator, PasswordValidator, PasswordMatchValidator,
    PasswordCharsValidator, FieldRequiredValidator, SelectFieldValidator
)
from formidable.exceptions import EmailError, PasswordError, FieldRequiredError, SelectFieldError
...
def test_select_field_validator():
    ...
    with pytest.raises(SelectFieldError):
        invalid_option_validator = SelectFieldValidator("invalid", ["option1", "option2"], "Select Field")
